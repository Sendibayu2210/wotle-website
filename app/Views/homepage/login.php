...
<div class="row card-login">
    <div class="login col-lg-5 px-5 py-3">
        ...
        <div class="col-lg-10  ms-lg-5 ps-lg-0 ms-md-5 ps-md-2 ps-ms-0">
            <form action="#" method="post">
                <?= csrf_field(); ?>
                <div class="text-center mb-5 h4 color-wotle">Masuk ke akun</div>
                ...
                <div class="mb-3">
                    <label for="" class="small text-muted">Kata sandi</label>
                ...
                <div class="mb-3 d-flex justify-content-between">
                    ...
                    <a href="/forgot-password" class="small text-muted">Lupa kata sandi ?</a>
                </div>
                <button type="button" class="btn  btn-login mt-3 w-100">Masuk</button>
                <div class="text-center mt-4">
                    <a href="/register" class="small text-wotle">Daftar Akun Baru</a>
                </div>
            </form>
        </div>
    </div>
    <div class="background-login col-lg-7">
        <img src="/wotle_assets/img/background_login.png" alt="">
    </div>
</div>
