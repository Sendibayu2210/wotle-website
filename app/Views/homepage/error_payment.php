...
<div id="payment-message" data-category="errorpayment">
    <div class="container">
        ...
        <div class="text-center mt-5 d-flex justify-content-center">
            <div class="card border-0 bg-transparent mt-5">
                <div class="card-body">         
                    <div class="h1 animate__animated animate__tada animate-check"><i class="fa-solid fa-triangle-exclamation text-warning h1"></i></div>
                    <div class="h3 fw-bold text-warning animate__animated animate__rubberBand animate-text">Pembayaran Error</div>
                    <div class="mt-3 text-muted">Oopps! Maaf sepertinya terjadi kendala.</div>
                </div>
            </div>        
        </div>
    </div>
